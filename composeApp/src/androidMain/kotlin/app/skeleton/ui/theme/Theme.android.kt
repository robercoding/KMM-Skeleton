...
actual fun UpdateStatusBarColor(useDarkIcons: Boolean) {
    val developmentPreference = koinInject<SettingsPreference>()
    val currentSystemThemeIsDarkMode = isSystemInDarkTheme()
    val isDarkMode by developmentPreference.getBooleanFlow(SettingsPreference.PREFERENCE_THEME_IS_DARK_MODE).collectAsStateWithLifecycle(null)
